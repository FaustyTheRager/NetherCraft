...
public class BlockConnectedTexturesBase extends BlockBase {
     ...
     */
    public BlockConnectedTexturesBase(String name, Material material, SoundType soundType, float hardness, String path) {
        super(name, material, soundType, hardness);
        this.path = path;
        this.setBlockTextureName("nethercraft:" + path + "0");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        for (int i = 0; i < icons.length; ++i) {
            this.icons[i] = reg.registerIcon("nethercraft:" + path + i);
        }
    }
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        if (!connectionAllowed(world, x, y, z, side)) {
            return icons[0];
        }
        boolean[] a = getB(world, x, y, z);
        switch (side) {
            case 0:
                if ((Fsurrounded != -1) && (allB(true, a[0], a[1], a[4], a[5]))) {
                    return icons[Fsurrounded];
                }
                if (Fedge3 != -1) {
                    if (allB(true, a[0], a[1], a[5])) {
                        return icons[Fedge3];
                    }
                    if (allB(true, a[0], a[1], a[4])) {
                        return icons[Fedge3 + 2];
                    }
                    if (allB(true, a[4], a[5], a[1])) {
                        return icons[Fedge3 + 3];
                    }
                    if (allB(true, a[4], a[5], a[0])) {
                        return icons[Fedge3 + 1];
                    }
                }
                if (FinLine != -1) {
                    if (allB(true, a[0], a[1])) {
                        return icons[FinLine];
                    }
                    if (allB(true, a[4], a[5])) {
                        return icons[FinLine + 2];
                    }
                }
                if (Fcorner != -1) {
                    if (allB(true, a[1], a[5])) {
                        return icons[Fcorner];
                    }
                    if (allB(true, a[0], a[5])) {
                        return icons[Fcorner + 1];
                    }
                    if (allB(true, a[0], a[4])) {
                        return icons[Fcorner + 2];
                    }
                    if (allB(true, a[1], a[4])) {
                        return icons[Fcorner + 3];
                    }
                }
                if (Fjust1 != -1) {
                    if (a[5]) {
                    ...
                    if (a[0]) {
                        return icons[Fjust1 + 1];
                    }
                    if (a[4]) {
                        return icons[Fjust1 + 2];
                    }
                    if (a[1]) {
                        return icons[Fjust1 + 3];
                    }
                }
                return icons[Falone];
            case 1:
                ...
                return icons[Falone];
            case 2:
                if ((Fsurrounded != -1) && (allB(true, a[0], a[1], a[2], a[3]))) {
                    return icons[Fsurrounded];
                }
                if (Fedge3 != -1) {
                    if (allB(true, a[0], a[1], a[3])) {
                        return icons[Fedge3 + 2];
                    }
                    if (allB(true, a[0], a[1], a[2])) {
                        return icons[Fedge3];
                    }
                    if (allB(true, a[2], a[3], a[1])) {
                        return icons[Fedge3 + 1];
                    }
                    if (allB(true, a[2], a[3], a[0])) {
                        return icons[Fedge3 + 3];
                    }
                }
                if (FinLine != -1) {
                    ...
                    if (allB(true, a[2], a[3])) {
                        return icons[FinLine + 1];
                    }
                }
                if (Fcorner != -1) {
                    if (allB(true, a[1], a[3])) {
                        return icons[Fcorner + 2];
                    }
                    if (allB(true, a[0], a[3])) {
                        return icons[Fcorner + 3];
                    }
                    if (allB(true, a[0], a[2])) {
                        return icons[Fcorner];
                    }
                    if (allB(true, a[1], a[2])) {
                        return icons[Fcorner + 1];
                    }
                }
                if (Fjust1 != -1) {
            ...
            case 3:
                ...
                return icons[Falone];
            case 4:
                if ((Fsurrounded != -1) && (allB(true, a[4], a[5], a[2], a[3]))) {
                    return icons[Fsurrounded];
                }
                if (Fedge3 != -1) {
                    if (allB(true, a[4], a[5], a[3])) {
                        return icons[Fedge3 + 2];
                    }
                    if (allB(true, a[4], a[5], a[2])) {
                        return icons[Fedge3];
                    }
                    if (allB(true, a[2], a[3], a[5])) {
                        return icons[Fedge3 + 3];
                    }
                    if (allB(true, a[2], a[3], a[4])) {
                        return icons[Fedge3 + 1];
                    }
                }
                if (FinLine != -1) {
                ...
                if (Fcorner != -1) {
                    if (allB(true, a[5], a[3])) {
                        return icons[Fcorner + 3];
                    }
                    if (allB(true, a[4], a[3])) {
                        return icons[Fcorner + 2];
                    }
                    if (allB(true, a[4], a[2])) {
                        return icons[Fcorner + 1];
                    }
                    if (allB(true, a[5], a[2])) {
                        return icons[Fcorner];
                    }
                }
                if (Fjust1 != -1) {
    ...
    private boolean matchBlock(IBlockAccess world, int x, int y, int z) {
        for (Block b : FblockConnectionAllowed) {
            if (world.getBlock(x, y, z).equals(b)) {
                return true;
            }
        }
        return false;
